...
const CACHE_VERSION = "v20260711-5";
const CACHE_NAME = "app-" + CACHE_VERSION;
// 새 js/에셋 파일을 추가하면 여기에도 추가 (Paws-Order 누락 전례)
const PRECACHE = ["./", "./index.html", "./manifest.json", "./styles.css?v=20260711-5", "./js/main.js?v=20260711-5", "./assets/card-art-sprite.jpg", "./icon-192.png", "./icon-512.png"];
